...
namespace Lab4.Controllers
{
    public class ApartmentsController : Controller
    {
        ...
        public ApartmentsController(PublicUtilitiesContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Area,Address,TenantsCount")] Apartment apartment)
        {
            if (id != apartment.Id)
            {
                return NotFound();
