...
namespace Lab4.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(PublicUtilitiesContext context)
        {
            _context = context;
        }
        ...
        {
            var publicUtilitiesContext = _context.Payment.Include(p => p.Apartment).Include(p => p.Service);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ServiceId,ApartmentId")] Payment payment)
        {
            if (id != payment.Id)
            {
                return NotFound();
