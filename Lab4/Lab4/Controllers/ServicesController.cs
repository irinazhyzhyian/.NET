...
namespace Lab4.Controllers
{
    public class ServicesController : Controller
    {
        ...
        {
            var publicUtilitiesContext = _context.Services.Include(s => s.Method);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MethodId,Price,Service")] Services services)
        {
            if (id != services.Id)
            {
                return NotFound();
